    ...
    <div className="fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-neutral-200 shadow-lg">
      <div className="mx-auto max-w-7xl px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <p className="text-xs text-neutral-600 leading-relaxed flex-1">
          Vi bruker informasjonskapsler for analyse og markedsføring.
          Nødvendige cookies brukes alltid for at siden skal fungere.{" "}
          <Link
        ...
        <div className="flex gap-2 flex-shrink-0">
          <button
            ...
            className="px-4 py-2 text-[11px] font-medium uppercase tracking-wider border border-black text-black hover:bg-neutral-100 transition-colors cursor-pointer"
          >
            Avslå
          </button>
          <button
            onClick={() => handleAccept("all")}
            className="px-4 py-2 text-[11px] font-medium uppercase tracking-wider border border-black bg-black text-white hover:bg-neutral-800 transition-colors cursor-pointer"
          >
            Godta
          </button>
        </div>
